...
const { insertUser } = require("../models/UsuariosModel");
...
describe("registerUser", () => {
  ...
  it('debería responder con un error si las credenciales son inválidas', async () => {
    ...
    const originalGetUserByEmail = UsuariosModel.getUserByEmail;
    const originalBcryptCompare = bcrypt.compare;

    UsuariosModel.getUserByEmail = mockGetUserByEmail;
    ...
    UsuariosModel.getUserByEmail = originalGetUserByEmail;
